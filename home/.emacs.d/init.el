...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (json-mode flymake-go company-go go-mode flycheck-haskell haskell-mode company flycheck-elm eslint-fix js2-mode jtags purescript-mode flycheck-purescript elm-mode enh-ruby-mode magit ledger-mode flycheck evil editorconfig coffee-mode)))
